...
/tmp/codeql-binaries/codeql-runner-linux analyze --repository PrLemon/codescan-jenkins --github-url https://github.com --github-auth $GITHUB_CREDS_PSW --commit $GIT_COMMIT --ref $GIT_REF'''
      }
    }
